...
class App extends Component {
  ...
  calculateChange(e) {
    ...
    let pennies = Math.ceil(subTotal - ones * 100 - quarters * 25 - dimes * 10 - nickels * 5);
  ...
  render() {
    ...
    return (
      ...
      <div className='container'>
        <h1 style={{ color: 'white', padding: '15px', textSizeAdjust: '100%' }}>Change Calculator</h1>
          ...
          <div className='col-4'>
            <div className='card'>
              ...
              <div className='card-body'>
                ...
                <br></br>
                <br></br>
                <h4 className="card-title">How much was received?</h4>
